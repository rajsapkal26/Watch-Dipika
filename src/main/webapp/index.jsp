    ...
    <section class="container my-3">
        <div class="d-flex align-items-center justify-content-between">
            ...
            <div>
                <div>
                    <div>
                        <p class="m-0  d-flex align-items-center icon" data-bs-toggle="offcanvas" data-bs-target="#offcanvasTop" role="button"><i class="bi bi-person-fill me-2 fs-4"></i><span class="d-none d-md-block para3">Log in</span></p>
                        <div class="offcanvas offcanvas-top h-75" tabindex="-1" id="offcanvasTop" aria-labelledby="offcanvasTopLabel">
                            <div class="offcanvas-header container">
                              <h5 class="offcanvas-title text-uppercase display-5 logo" id="offcanvasTopLabel"><img src="images/illustration/logo.webp" alt="logo"></h5>
                              <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                            </div>
                            <div class="offcanvas-body container">
                                <div class="d-md-flex justify-content-between">
                                    <div class="col-md-5">
                                        <h1 class="mb-3 second">LOGIN</h1>
                                        <form class="my-2" action="login.jsp" method="post">
                                            <div class="my-2 d-md-flex justify-content-evenly col-sm-6 col-md-12"> 
                                                <p class="m-0 col-md-6 para5"><label for="mail">E-mail</label></p>
                                                <input type="email" class="col-12 col-md-6" name="input1" id="mail"/>
                                            </div>
                                            <div class="my-2 d-md-flex justify-content-evenly col-sm-6 col-md-12">
                                                <p class="m-0 col-md-6 para5"><label for="pass">Password</label></p>
                                    ...
                                    <div class="col-md-5">
                                        <h1 class="mt-4 mt-md-0 text-uppercase second">Are you a new customer?</h1>
                                        <p>Register and get many benefits:</p>
                                        <div>
                                            <p><i class="bi bi-check-lg me-2 para5"></i> Checking the product availability</p>
                                            <p><i class="bi bi-check-lg me-2 para5"></i> Fast reordering & order history</p>
                                            <p><i class="bi bi-check-lg me-2 para5"></i> Personal product recommendation</p>
                                            <p><i class="bi bi-check-lg me-2 para5"></i> Payment by invoice </p>
                                        </div>
                                        <div>
                                            <a href="register.jsp" class="d-flex text-decoration-none justify-content-center align-items-center border border-2 col-5 col-xxl-4 para5">Register Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="box">
                            <figure class="bg-white p-2 p-sm-3">
                                ...
                                <figcaption>
                                    ...
                                    <a class="text-decoration-none text-white d-flex justify-content-center" data-bs-toggle="offcanvas" data-bs-target="#offcanvasTop" role="button"><span class="m-0 cart bg-dark">Add to cart</span></a>
                                </figcaption>
                            </figure>
                        </div>
                    </div>
