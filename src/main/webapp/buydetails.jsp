...
<body class="px-3">
	...
	<h1 class="text-center second mt-5">BUY-DETAILS</h1>
	<%
int total=0;
	...
	try {
		...
		<table class="table table-bordered container my-5">
			<thead>
				<tr>
					<th class="ps-5 third">Product Info</th>
					<th class="third">Price</th>
					<th class="third">Order Date</th>
					<th class="third">Delivery Date</th>
				</tr>
			</thead>
		<%
		...
		while(rs.next()) {
			...
			<tbody>
				<tr>
					<td>
						<div class="d-flex">
							<img src="<%=rs.getString(3) %>" class="img-fluid" width="170"/>
							<div class=" px-2">
					...
					<td>
						<p class="para6"><%=currentDate  %></p>
					</td>
					<td>
						<p class="para6"><%=modifiedDate %></p>
					</td>
				</tr>
			</tbody>
	...
	<div class="container">
		<div>
			<p class="d-flex justify-content-center third">Total Amount : <%=total%></p>
		</div>
		<div class="d-flex justify-content-center mb-5">
		<h3 class="btn btn-success rounded-0">Payment: Cash On Delivery</h3>
		</div>
	</div>
